...
set_global_assignment -name TOP_LEVEL_ENTITY calculator2
set_global_assignment -name PROJECT_OUTPUT_DIRECTORY ../output_files

# 2] include your relative path files here
set_global_assignment -name VHDL_FILE ../../src/calculator2.vhd
...
set_location_assignment PIN_AF9  -to in_switches[0]
set_location_assignment PIN_AF10 -to in_switches[1]
set_location_assignment PIN_AD11 -to in_switches[2]
set_location_assignment PIN_AD12 -to in_switches[3]
set_location_assignment PIN_AE11 -to in_switches[4]
set_location_assignment PIN_AC9  -to in_switches[5]
set_location_assignment PIN_AD10 -to in_switches[6]
set_location_assignment PIN_AE12 -to in_switches[7]
